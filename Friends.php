...
?><td>
                    <div class="Friend">
                        <div class="Avatar"><a title="<?=addslashes($user['username'])?>" href="/User.aspx?ID=<?=$user['id']?>" style="display:inline-block;cursor:pointer;"><img src="/img/user/<?=$user['id']?>.png?rand=<?=random_int(1, 999999999999999999)?>" width="95" height="111" border="0" alt="<?=addslashes($user['username'])?>" blankurl="http://t6-cf.roblox.com/blank-100x100.gif"></a></div>
                        <div class="Summary">
